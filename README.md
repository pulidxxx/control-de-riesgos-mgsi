# MGSI - Metodología de Gestión de Riesgos de Seguridad de la Información
...
-   Análisis y evaluación de ciber-riesgos
...
```bash
git clone https://github.com/pulidxxx/control-de-riesgos-mgsi.git
cd control-de-riesgos-mgsi
```
